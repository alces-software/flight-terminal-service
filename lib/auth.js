...
function fetchTerminalServicesConfig(cookie, serviceType, siteId, clusterId) {
  let url;
  if (clusterId != null) {
    url = `${centerBaseUrl}/clusters/${clusterId}/terminal_services?service_type=${serviceType}`;
  } else if (siteId != null) {
