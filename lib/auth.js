...
function configure(authData, terminalServiceConfig, store) {
  if (terminalServiceConfig.flight_directory_config != null) {
    storeAuthData(store, authData);
    configureCmd(store, terminalServiceConfig.flight_directory_config);
    return true;
  } else {
    return false;
  }
...
function storeAuthData(store, authData) {
