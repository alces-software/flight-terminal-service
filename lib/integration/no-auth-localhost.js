...
// This integration always authenticates the request and runs the command set
// in `process.env.CMD_EXE` with the arguments specified in the file given by
// `process.env.CMD_ARGS_FILE`.
//
...
function authenticate(socket, data, callback) {
  ...
  // use the cmd specified by `process.env.CMD_ARGS_FILE`  with the arguments
  // specified in the file given by `process.env.CMD_ARGS_FILE`.
  //
